...
Game.ExecutableName = "AoE3DE_s.exe";
Game.SteamID = "933110";
Game.GUID = "Age of Empires III Definitive Edition";
Game.GameName = "Age of Empires III: Definitive Edition";
...
Game.UserProfileConfigPath = "Games\\Age of Empires 3 DE\\Common";
...
Game.Hook.ForceFocusWindowName = "Age of Empires III: Definitive Edition";
...
Game.Play = function () {
  ...
  var exe = "AoE3DE_s.exe";
  var SLoader = "steamclient_loader_x64.exe"; // Steam loader
  var Args = "+noIntroCinematics"; // Command line argument.
  var AppId = "933110"; // Steam AppId.
  ...
  if (Context.PlayerID == 0) {
    ...
    var lines = [
      "lan\\launcher\\launcher_aoe3.bat"
    ];
  } else {
    var lines = [
      "start " + SLoader
  ...
  var svrtxtPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\lan\\launcher\\resources\\config.aoe3.toml";
  ...
  // The game configs
  // var xmlPath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\GraphicalProfile.xml";
  // Context.ChangeXmlAttributeValue(xmlPath, "//name", "optiongrfxres", Context.Width + "x" + Context.Height);
