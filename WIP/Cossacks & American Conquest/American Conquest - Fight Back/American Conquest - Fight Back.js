...
Game.ExecutableContext = ["amerika.dll"];
// Game.ExecutableToLaunch = "dmln.exe";
Game.SteamID = "115220";
Game.GUID = "American Conquest - Fight Back";
Game.GameName = "American Conquest - Fight Back";
Game.MaxPlayers = 7;
Game.MaxPlayersOneMonitor = 7;
Game.FileSymlinkExclusions = ["mdraw.dll", "ddraw.ini", "dplayx.dll"];
...
Game.Description =
  ...
  "PS:\n" + 
  "- If the bottom instances have cutoff press middile mouse button on the window (this will work on 1080 or 768 height screens).\n" +
  "- If the game didn't start, try launch Nucleus as administrator"
...
Game.Play = function () {
  ...
  var savePath = (Context.SavePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\mdraw.dll");
  var savePkgOrigin = System.IO.Path.Combine(Game.Folder, "mdraw.dll");
