...
Game.SteamID = "612520";
Game.GUID = "Sudden Strike 2";
Game.GameName = "Sudden Strike 2";
Game.MaxPlayers = 12;
...
Game.Play = function () {
  ...
  if (System.IO.File.Exists(Context.OrigRootFolder + "\\n2Menu_dll.dll")) {
    Game.BinariesFolder = "";
    Game.FileSymlinkCopyInstead = ["n2Cad640.dll", "n2Cad800.dll", "n2Cad1024.dll", "n2Game_Dll.dll", "n2Menu_dll.dll", "n2Text_dll.dll"];
  } else {
